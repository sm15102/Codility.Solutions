namespace Codility.Solutions.Arrays
{
    /*
    ...
    public static class CyclicRotation
    {
        public static int[] Solution(int[] A, int K)
        {
            ...
            var startIndex = A.Length - K;
            var result = new int[A.Length];

            Array.ConstrainedCopy(A, startIndex, result, 0, A.Length - startIndex);
            Array.ConstrainedCopy(A, 0, result, A.Length - startIndex, startIndex);
